...
const int BASELINE_TEMP = 0;
const int BASELINE_INTERVAL = 20;
const int BASELINE_TEMP_LEVEL_1 = BASELINE_TEMP;
const int BASELINE_TEMP_LEVEL_2 = BASELINE_TEMP+BASELINE_INTERVAL;
const int BASELINE_TEMP_LEVEL_3 = BASELINE_TEMP+(2*BASELINE_INTERVAL);
const int BASELINE_TEMP_LEVEL_4 = BASELINE_TEMP+(3*BASELINE_INTERVAL);
